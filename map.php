...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a href="#accessibility-map" class="skip">Skip to main content</a>
  ...
  <body id="accessibility-map" onresize="if(window.outerWidth > 800) document.getElementById('map').hidden = false;">
    <div id="routing">
        <aside id="sidebar-container">
            <div id="sidebar">
                <div id="route-input">
                  <button type="button"  class="img-btn" onclick="document.getElementById('map').hidden = !document.getElementById('map').hidden;"><img src="assets/funnel-fill.svg" id="filter-access" alt="icon to bring up access features checkboxes"></button>
                    <div id="input-fields">
                        <div class="input-group mb-3">
                          <select class="form-select" aria-label="Select starting building" id="start-building" name="start-building" onchange="propogateFloors('start-building', 'start-floor')">
                            ...
                            <option>Dewey</option>
                            <option>Hoyt</option>
                            <option>Interfaith Chapel</option>
                            <option>Lattimore</option>
                    ...
                    <button type="button" class="img-btn"  onclick="switchInput()"><img src="assets/bx-transfer.svg" alt="icon to switch starting location with destination"></button>
                </div>
                <div id="route-info">
                ...
                <div id="route-directions" hidden>
                  <div id="input-bar">
                    <img src="assets/arrow-return-left.svg" id="redo-input" alt="icon to go back to adjust route requirements" role="button" onclick="adjustRoute()">
                  ...
                  <div id="current-dir-box" class="current-dir">
                    <div class="dir-step-overview">
                      <button type="button"  class="img-btn" onclick="document.getElementById('map').hidden = !document.getElementById('map').hidden;"><img src="assets/list-task.svg" id="toggle-dir" alt="icon to bring up list of all steps for route"></button>
                      <p id="current-dir-building"></p>
                      <p id="current-dir-type"></p>
                      <button type="button" class="img-btn" onclick="console.log('report function')"><img src="assets/exclamation-octagon-fill.svg" class="dir-step-report" alt="icon to report broken access feature for this step in the route"></button>
                    </div>
                    <div class="form-check dir-step" id="current-dir-check">
                      ...
                      <label class="form-check-label" for="">
                        <p id="current-dir-step"></p>
                      </label>
                    </div>
                  </div>
                </div>
                <button type="submit" class="btn btn-primary" id="find-route" onclick="find_route(event)">Go</button> 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating">
                    <input type="email" autocomplete="email" class="form-control required" id="map-reporter-email" placeholder="University Email" required = "true">
                    <label for="map-reporter-email"><span style="color: red;">*</span> University Email</label>
                </div>
                <div class="form-floating">
                    <input type="tel" autocomplete="tel" class="form-control required" id="map-reporter-phone" placeholder="Phone Number" required = "true">
